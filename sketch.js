...
function preload() {
  video = createVideo("trakiyska.mp4", () => { video.hide(); videoLoaded = true; });
  img = loadImage("trakiyska-colours.png", () => imgLoaded = true);
  icon = loadImage("trakiyska-icon.png", () => iconLoaded = true);
